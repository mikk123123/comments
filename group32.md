...
对于代码零基础的我来说，这门课刚开始一度让我退缩。从安装软件处处受挫到勉强完成数据分析，这中间少不了高老师的有效指导和同学的帮助。学习完这门课程后，我最大的收获就是实验数据不仅仅是用来处理和绘图，更要保证它的可复现性，在科学研究中要始终保持着严谨的态度。同时，目前虽然不能有效地编写代码，但对科研来说它是必要的，有帮助的，也是可以被慢慢学习和运用的。
